...
import { ShoppingComponent } from './modules/board/shopping/shopping.component'
import { AccountComponent } from './modules/board/account/account.component'
import { UserComponent } from './modules/board/user/user.component'
...
import { AccountEditComponent } from './modules/board/account/account-edit.component'
...
export const routes: Routes = [
    ...
    { path: 'account/:id', component: AccountEditComponent, canActivate: [AuthenticatedGuard] },
    { path: 'account/:id/edit', component: AccountEditComponent, canActivate: [AuthenticatedGuard] },
