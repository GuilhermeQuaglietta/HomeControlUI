  ...
  private carregarMenu(): Array<IMenu> {
    ...
    menuPrincipal = [
      ...
      },
      {
        ...
        subMenu: [
          { nome: "Cadastrar conta", icone: faPlus, url: "contas/novo" },
          { nome: "Consultar contas", icone: faWallet, url: "contas" },
          { separator: true },
          { nome: "Fluxo mês a mês", icone: faChartLine, url: "contas/stats/mesames" },
          { separator: true },
          { nome: "Estatisticas", icone: faChartBar, url: "contas/stats" },
        ]
      },
      {
